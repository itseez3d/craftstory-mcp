 ...
 * --h3 also creates a 5 s MiniMax H3 basic job (costs credits) and waits for it.
 */
...
const bad = await call("create_audio_clip", { text: "x", voice_id: "11111111-1111-1111-1111-111111111111" });
